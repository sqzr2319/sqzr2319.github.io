...
3. 在地图中设置传送门
4. 在地图中设置镜子，镜子两面的图形始终为镜像（即更改一边的图形会同时更改另一边的图形）
5. 在地图中设置奇迹宝珠，奇迹宝珠打开时会更改地图中一部分地区的重力（如将重力方向旋转60度）
6. 在地图中设置固定死亡点与受重力影响的炸弹，玩家触碰到这些物体时会死亡
7. 设置一个影分身，影分身与玩家初始位置相同，但重力方向相反，玩家在行进过程中不能与影分身重合

#### 分工

褚一枫：主代码框架、基本玩法、游戏元素、游戏中界面、暂停界面、通关界面、死亡界面

剩余部分包括：
1. 其余界面：开始界面、设置界面、帮助界面、关卡选择界面
2. 美工：剧情、音效、贴图、动画
3. **关卡设计**
4. 其他功能：存读档等

建议：1、2由一人完成，3、4由另一人完成。
